...
In the `frontend` directory, you can find various experiments and examples related to:
...
In the `backend` directory, there will be stuff you can experiment with concerning:
